...
## Project Structure
    ...
    ├── testapiautodatamod_103234  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_103234`
...
2. Clone this repo and `cd testapiautodatamod_103234`
